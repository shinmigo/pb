...
func (*Payload) Descriptor() ([]byte, []int) {
	return fileDescriptor_hello_acaca3be1d20be1d, []int{0}
}
...
func init() {
	proto.RegisterType((*Payload)(nil), "pruductpb.Payload")
}
...
func (c *helloServiceClient) Echo(ctx context.Context, in *Payload, opts ...grpc.CallOption) (*Payload, error) {
	out := new(Payload)
	err := c.cc.Invoke(ctx, "/pruductpb.HelloService/Echo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloService_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pruductpb.HelloService/Echo",
	}
...
var _HelloService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pruductpb.HelloService",
...
func init() { proto.RegisterFile("hello.proto", fileDescriptor_hello_acaca3be1d20be1d) }

var fileDescriptor_hello_acaca3be1d20be1d = []byte{
	// 116 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0xe2, 0xce, 0x48, 0xcd, 0xc9,
	0xc9, 0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x2c, 0x28, 0x2a, 0x4d, 0x29, 0x4d, 0x2e,
	...
	0x62, 0x48, 0x62, 0x03, 0x5b, 0x69, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xcc, 0xd0, 0x6c, 0x60,
	0x81, 0x00, 0x00, 0x00,
}
